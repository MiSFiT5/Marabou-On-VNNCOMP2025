...
## Special samples
In the experiments some samples generated by MCMC are not predicted as the target class by the classifier, but they are still in the feasible region of the NAP constraints. 
