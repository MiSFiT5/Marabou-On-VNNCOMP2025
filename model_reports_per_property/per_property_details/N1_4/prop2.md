...
| `Impl L3→L4 (α=0.9)` | 🟢 Y (0s) | 🟢 Y (3s) | 🟡 T/o (120s) | 🔴 N (16s) |
| `Impl L3→L4 (α=0.95)` | 🟢 Y (0s) | 🟢 Y (41s) | 🔴 N (2s) | 🔴 N (2s) |
| `Impl L3→L4 (α=0.99)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (4s) | 🔴 N (3s) |
| `Impl L4→L5 (α=0.9)` | 🟢 Y (7s) | 🔴 N (6s) | 🔴 N (2s) | 🔴 N (3s) |
| `Impl L4→L5 (α=0.95)` | 🔴 N (0s) | 🔴 N (4s) | 🔴 N (2s) | 🔴 N (3s) |
...
| `Impl L1→L2 (α=0.95)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (2s) | 🔴 N (2s) |
| `Impl L1→L2 (α=0.99)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (2s) | 🔴 N (2s) |
| `Impl L2→L3 (α=0.9)` | 🟢 Y (0s) | 🔴 N (1s) | 🔴 N (8s) | 🔴 N (5s) |
| `Impl L2→L3 (α=0.95)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (2s) | 🔴 N (10s) |
| `Impl L2→L3 (α=0.99)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (2s) | 🔴 N (2s) |
| `Impl L3→L4 (α=0.9)` | 🟢 Y (0s) | 🟢 Y (3s) | 🟡 T/o (120s) | 🔴 N (3s) |
| `Impl L3→L4 (α=0.95)` | 🟢 Y (0s) | 🔴 N (13s) | 🔴 N (9s) | 🔴 N (3s) |
| `Impl L3→L4 (α=0.99)` | 🔴 N (1s) | 🔴 N (1s) | 🔴 N (3s) | 🔴 N (2s) |
| `Impl L4→L5 (α=0.9)` | 🟢 Y (11s) | 🔴 N (6s) | 🔴 N (2s) | 🔴 N (3s) |
| `Impl L4→L5 (α=0.95)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (3s) | 🔴 N (2s) |
| `Impl L4→L5 (α=0.99)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (9s) | 🔴 N (3s) |
...
| `Impl L1→L2 (α=0.95)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (2s) | 🔴 N (2s) |
| `Impl L1→L2 (α=0.99)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (2s) | 🔴 N (3s) |
| `Impl L2→L3 (α=0.9)` | 🟢 Y (0s) | 🔴 N (1s) | 🔴 N (13s) | 🔴 N (3s) |
| `Impl L2→L3 (α=0.95)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (2s) | 🔴 N (3s) |
| `Impl L2→L3 (α=0.99)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (2s) | 🔴 N (3s) |
| `Impl L3→L4 (α=0.9)` | 🟢 Y (0s) | 🟢 Y (3s) | 🔴 N (12s) | 🔴 N (3s) |
| `Impl L3→L4 (α=0.95)` | 🟢 Y (0s) | 🟢 Y (60s) | 🔴 N (1s) | 🔴 N (2s) |
| `Impl L3→L4 (α=0.99)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (2s) | 🔴 N (2s) |
| `Impl L4→L5 (α=0.9)` | 🟢 Y (7s) | 🔴 N (5s) | 🔴 N (1s) | 🔴 N (3s) |
| `Impl L4→L5 (α=0.95)` | 🔴 N (0s) | 🔴 N (18s) | 🔴 N (2s) | 🔴 N (2s) |
| `Impl L4→L5 (α=0.99)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (2s) | 🔴 N (3s) |
