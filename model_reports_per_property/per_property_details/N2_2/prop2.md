...
| `Impl L0→L1 (α=0.99)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (32s) | 🔴 N (5s) |
| `Impl L1→L2 (α=0.9)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (5s) | 🔴 N (10s) |
| `Impl L1→L2 (α=0.95)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (25s) | 🔴 N (18s) |
| `Impl L1→L2 (α=0.99)` | 🔴 N (0s) | 🔴 N (2s) | 🔴 N (46s) | 🔴 N (10s) |
| `Impl L2→L3 (α=0.9)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (23s) | 🔴 N (11s) |
| `Impl L2→L3 (α=0.95)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (29s) | 🔴 N (15s) |
| `Impl L2→L3 (α=0.99)` | 🔴 N (1s) | 🔴 N (1s) | 🔴 N (39s) | 🔴 N (9s) |
| `Impl L3→L4 (α=0.9)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (40s) | 🔴 N (66s) |
| `Impl L3→L4 (α=0.95)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (102s) | 🔴 N (28s) |
| `Impl L3→L4 (α=0.99)` | 🔴 N (1s) | 🔴 N (1s) | 🔴 N (81s) | 🔴 N (22s) |
| `Impl L4→L5 (α=0.9)` | 🔴 N (1s) | 🔴 N (1s) | 🔴 N (90s) | 🔴 N (34s) |
| `Impl L4→L5 (α=0.95)` | 🔴 N (0s) | 🔴 N (2s) | 🔴 N (117s) | 🔴 N (23s) |
| `Impl L4→L5 (α=0.99)` | 🔴 N (0s) | 🔴 N (7s) | 🔴 N (108s) | 🔴 N (14s) |
...
| `Impl L1→L2 (α=0.9)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (5s) | 🔴 N (37s) |
| `Impl L1→L2 (α=0.95)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (4s) | 🔴 N (19s) |
| `Impl L1→L2 (α=0.99)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (3s) | 🔴 N (21s) |
| `Impl L2→L3 (α=0.9)` | 🔴 N (1s) | 🔴 N (1s) | 🔴 N (4s) | 🔴 N (11s) |
| `Impl L2→L3 (α=0.95)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (8s) | 🔴 N (16s) |
| `Impl L2→L3 (α=0.99)` | 🔴 N (1s) | 🔴 N (2s) | 🔴 N (5s) | 🔴 N (13s) |
| `Impl L3→L4 (α=0.9)` | 🔴 N (1s) | 🔴 N (1s) | 🔴 N (3s) | 🔴 N (21s) |
| `Impl L3→L4 (α=0.95)` | 🔴 N (1s) | 🔴 N (1s) | 🔴 N (4s) | 🔴 N (25s) |
| `Impl L3→L4 (α=0.99)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (4s) | 🔴 N (24s) |
| `Impl L4→L5 (α=0.9)` | 🔴 N (1s) | 🔴 N (2s) | 🔴 N (95s) | 🔴 N (35s) |
| `Impl L4→L5 (α=0.95)` | 🔴 N (1s) | 🔴 N (1s) | 🔴 N (8s) | 🔴 N (57s) |
| `Impl L4→L5 (α=0.99)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (8s) | 🔴 N (24s) |
...
| `Impl L1→L2 (α=0.9)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (6s) | 🔴 N (10s) |
| `Impl L1→L2 (α=0.95)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (4s) | 🔴 N (27s) |
| `Impl L1→L2 (α=0.99)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (4s) | 🔴 N (16s) |
| `Impl L2→L3 (α=0.9)` | 🔴 N (0s) | 🔴 N (2s) | 🔴 N (5s) | 🔴 N (31s) |
| `Impl L2→L3 (α=0.95)` | 🔴 N (1s) | 🔴 N (1s) | 🔴 N (8s) | 🔴 N (14s) |
| `Impl L2→L3 (α=0.99)` | 🔴 N (1s) | 🔴 N (1s) | 🔴 N (6s) | 🔴 N (14s) |
| `Impl L3→L4 (α=0.9)` | 🔴 N (1s) | 🔴 N (2s) | 🔴 N (3s) | 🔴 N (22s) |
| `Impl L3→L4 (α=0.95)` | 🔴 N (1s) | 🔴 N (1s) | 🔴 N (4s) | 🔴 N (98s) |
| `Impl L3→L4 (α=0.99)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (2s) | 🔴 N (23s) |
| `Impl L4→L5 (α=0.9)` | 🔴 N (1s) | 🔴 N (1s) | 🔴 N (76s) | 🔴 N (66s) |
| `Impl L4→L5 (α=0.95)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (9s) | 🟡 T/o (120s) |
| `Impl L4→L5 (α=0.99)` | 🔴 N (1s) | 🔴 N (2s) | 🔴 N (9s) | 🔴 N (20s) |
...
| `Impl L2→L3 (α=0.9)` | 🔴 N (1s) | 🔴 N (1s) | 🔴 N (4s) | 🔴 N (11s) |
| `Impl L2→L3 (α=0.95)` | 🔴 N (1s) | 🔴 N (1s) | 🔴 N (11s) | 🔴 N (16s) |
| `Impl L2→L3 (α=0.99)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (6s) | 🔴 N (15s) |
| `Impl L3→L4 (α=0.9)` | 🔴 N (1s) | 🔴 N (1s) | 🔴 N (8s) | 🔴 N (20s) |
| `Impl L3→L4 (α=0.95)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (3s) | 🔴 N (17s) |
| `Impl L3→L4 (α=0.99)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (4s) | 🔴 N (21s) |
| `Impl L4→L5 (α=0.9)` | 🔴 N (0s) | 🔴 N (2s) | 🔴 N (109s) | 🔴 N (35s) |
| `Impl L4→L5 (α=0.95)` | 🔴 N (0s) | 🔴 N (1s) | 🔴 N (7s) | 🔴 N (24s) |
| `Impl L4→L5 (α=0.99)` | 🔴 N (0s) | 🔴 N (2s) | 🔴 N (8s) | 🔴 N (25s) |
