...
|--------|------------|----------------|--------------------------|
| 1 | Weak Left | 0.05 | `Impl L3→L4 (α=0.9)` [B/L3→L4] |
| 2 | Weak Right | 0.10 | `Impl L3→L4 (α=0.9)` [B/L3→L4] |
| 3 | Strong Left | 0.05 | `Impl L3→L4 (α=0.9)` [B/L3→L4] |
| 4 | Strong Right | 0.05 | `Impl L3→L4 (α=0.9)` [B/L3→L4] |
...
| `Impl L2→L3 (α=0.9)` | implication-only (L2→L3) | Y (0s) | N (1s) | N (12s) | N (4s) |
| `Impl L2→L3 (α=0.95)` | implication-only (L2→L3) | N (0s) | N (1s) | N (2s) | N (3s) |
| `Impl L2→L3 (α=0.99)` | implication-only (L2→L3) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L3→L4 (α=0.9)` | implication-only (L3→L4) | Y (0s) | Y (3s) | T/o | N (7s) |
| `Impl L3→L4 (α=0.95)` | implication-only (L3→L4) | Y (0s) | N (5s) | N (1s) | N (2s) |
| `Impl L3→L4 (α=0.99)` | implication-only (L3→L4) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L4→L5 (α=0.9)` | implication-only (L4→L5) | Y (7s) | N (5s) | N (2s) | N (2s) |
| `Impl L4→L5 (α=0.95)` | implication-only (L4→L5) | N (0s) | N (28s) | N (1s) | N (2s) |
...
| `Impl L1→L2 [!A->B] (α=0.99)` | implication-direction (L1→L2) | N (0s) | N (1s) | N (5s) | N (2s) |
...
| `Impl L2→L3 [A->B] (α=0.9)` | implication-direction (L2→L3) | Y (1s) | N (1s) | N (2s) | N (2s) |
| `Impl L2→L3 [A->B] (α=0.95)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L2→L3 [A->B] (α=0.99)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L3→L4 [!A->!B] (α=0.9)` | implication-direction (L3→L4) | Y (0s) | N (17s) | N (2s) | N (3s) |
...
| `Impl L3→L4 [!A->B] (α=0.9)` | implication-direction (L3→L4) | Y (1s) | N (17s) | N (2s) | N (2s) |
| `Impl L3→L4 [!A->B] (α=0.95)` | implication-direction (L3→L4) | N (0s) | N (43s) | N (1s) | N (2s) |
| `Impl L3→L4 [!A->B] (α=0.99)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L3→L4 [A->!B] (α=0.9)` | implication-direction (L3→L4) | Y (2s) | N (1s) | N (1s) | N (2s) |
| `Impl L3→L4 [A->!B] (α=0.95)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L3→L4 [A->!B] (α=0.99)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L3→L4 [A->B] (α=0.9)` | implication-direction (L3→L4) | Y (0s) | N (12s) | N (1s) | N (2s) |
...
| `Impl L4→L5 [!A->!B] (α=0.9)` | implication-direction (L4→L5) | Y (9s) | N (1s) | N (1s) | N (2s) |
| `Impl L4→L5 [!A->!B] (α=0.95)` | implication-direction (L4→L5) | N (0s) | N (34s) | N (1s) | N (2s) |
| `Impl L4→L5 [!A->!B] (α=0.99)` | implication-direction (L4→L5) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L4→L5 [!A->B] (α=0.9)` | implication-direction (L4→L5) | N (0s) | N (1s) | N (5s) | N (2s) |
...
| `Impl L4→L5 [A->!B] (α=0.9)` | implication-direction (L4→L5) | N (0s) | N (11s) | N (1s) | N (2s) |
| `Impl L4→L5 [A->!B] (α=0.95)` | implication-direction (L4→L5) | N (0s) | N (7s) | N (4s) | N (2s) |
| `Impl L4→L5 [A->!B] (α=0.99)` | implication-direction (L4→L5) | N (0s) | N (1s) | N (7s) | N (2s) |
...
| `Impl L3→L4 (α=0.9)` | implication-only (L3→L4) | Y (0s) | Y (3s) | Y (96s) | N (3s) |
| `Impl L3→L4 (α=0.95)` | implication-only (L3→L4) | Y (0s) | Y (23s) | N (1s) | N (2s) |
| `Impl L3→L4 (α=0.99)` | implication-only (L3→L4) | N (1s) | N (1s) | N (1s) | N (2s) |
| `Impl L4→L5 (α=0.9)` | implication-only (L4→L5) | Y (5s) | N (6s) | N (1s) | N (2s) |
| `Impl L4→L5 (α=0.95)` | implication-only (L4→L5) | N (0s) | N (2s) | N (2s) | N (2s) |
| `Impl L4→L5 (α=0.99)` | implication-only (L4→L5) | N (0s) | N (1s) | N (7s) | N (2s) |
| `Impl L0→L1 [!A->!B] (α=0.9)` | implication-direction (L0→L1) | N (0s) | N (0s) | N (2s) | N (2s) |
...
| `Impl L2→L3 [A->!B] (α=0.95)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L2→L3 [A->!B] (α=0.99)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L2→L3 [A->B] (α=0.9)` | implication-direction (L2→L3) | Y (2s) | N (1s) | N (2s) | N (2s) |
| `Impl L2→L3 [A->B] (α=0.95)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (1s) | N (7s) |
| `Impl L2→L3 [A->B] (α=0.99)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L3→L4 [!A->!B] (α=0.9)` | implication-direction (L3→L4) | Y (0s) | N (21s) | N (3s) | N (2s) |
| `Impl L3→L4 [!A->!B] (α=0.95)` | implication-direction (L3→L4) | N (0s) | N (0s) | N (3s) | N (2s) |
| `Impl L3→L4 [!A->!B] (α=0.99)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L3→L4 [!A->B] (α=0.9)` | implication-direction (L3→L4) | Y (1s) | N (38s) | N (1s) | N (2s) |
| `Impl L3→L4 [!A->B] (α=0.95)` | implication-direction (L3→L4) | N (0s) | N (68s) | N (1s) | N (2s) |
| `Impl L3→L4 [!A->B] (α=0.99)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L3→L4 [A->!B] (α=0.9)` | implication-direction (L3→L4) | Y (2s) | N (1s) | N (1s) | N (3s) |
| `Impl L3→L4 [A->!B] (α=0.95)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L3→L4 [A->!B] (α=0.99)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L3→L4 [A->B] (α=0.9)` | implication-direction (L3→L4) | Y (0s) | T/o | N (2s) | N (2s) |
| `Impl L3→L4 [A->B] (α=0.95)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (1s) | N (2s) |
...
| `Impl L4→L5 [!A->B] (α=0.99)` | implication-direction (L4→L5) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L4→L5 [A->!B] (α=0.9)` | implication-direction (L4→L5) | N (0s) | N (11s) | N (1s) | N (2s) |
| `Impl L4→L5 [A->!B] (α=0.95)` | implication-direction (L4→L5) | N (0s) | N (7s) | N (1s) | N (2s) |
| `Impl L4→L5 [A->!B] (α=0.99)` | implication-direction (L4→L5) | N (0s) | N (1s) | N (2s) | N (2s) |
...
| `Impl L2→L3 (α=0.9)` | implication-only (L2→L3) | Y (0s) | N (1s) | N (7s) | N (6s) |
| `Impl L2→L3 (α=0.95)` | implication-only (L2→L3) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L2→L3 (α=0.99)` | implication-only (L2→L3) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L3→L4 (α=0.9)` | implication-only (L3→L4) | Y (0s) | Y (3s) | T/o | N (3s) |
| `Impl L3→L4 (α=0.95)` | implication-only (L3→L4) | Y (0s) | N (8s) | N (8s) | N (2s) |
| `Impl L3→L4 (α=0.99)` | implication-only (L3→L4) | N (0s) | N (1s) | N (3s) | N (2s) |
| `Impl L4→L5 (α=0.9)` | implication-only (L4→L5) | Y (7s) | N (5s) | N (1s) | N (3s) |
| `Impl L4→L5 (α=0.95)` | implication-only (L4→L5) | N (0s) | N (2s) | N (1s) | N (2s) |
| `Impl L4→L5 (α=0.99)` | implication-only (L4→L5) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L0→L1 [!A->!B] (α=0.9)` | implication-direction (L0→L1) | N (0s) | N (0s) | N (1s) | N (2s) |
| `Impl L0→L1 [!A->!B] (α=0.95)` | implication-direction (L0→L1) | N (0s) | N (1s) | N (1s) | N (1s) |
| `Impl L0→L1 [!A->!B] (α=0.99)` | implication-direction (L0→L1) | N (0s) | N (1s) | N (2s) | N (2s) |
...
| `Impl L2→L3 [!A->!B] (α=0.99)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L2→L3 [!A->B] (α=0.9)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L2→L3 [!A->B] (α=0.95)` | implication-direction (L2→L3) | N (0s) | N (0s) | N (2s) | N (21s) |
| `Impl L2→L3 [!A->B] (α=0.99)` | implication-direction (L2→L3) | N (0s) | N (0s) | N (2s) | N (2s) |
...
| `Impl L2→L3 [A->B] (α=0.9)` | implication-direction (L2→L3) | Y (1s) | N (1s) | N (1s) | N (2s) |
| `Impl L2→L3 [A->B] (α=0.95)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L2→L3 [A->B] (α=0.99)` | implication-direction (L2→L3) | N (0s) | N (0s) | N (1s) | N (3s) |
| `Impl L3→L4 [!A->!B] (α=0.9)` | implication-direction (L3→L4) | Y (0s) | N (22s) | N (2s) | N (2s) |
| `Impl L3→L4 [!A->!B] (α=0.95)` | implication-direction (L3→L4) | N (6s) | N (1s) | N (1s) | N (2s) |
| `Impl L3→L4 [!A->!B] (α=0.99)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L3→L4 [!A->B] (α=0.9)` | implication-direction (L3→L4) | Y (1s) | N (33s) | N (2s) | N (2s) |
| `Impl L3→L4 [!A->B] (α=0.95)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (1s) | N (4s) |
| `Impl L3→L4 [!A->B] (α=0.99)` | implication-direction (L3→L4) | N (0s) | N (10s) | N (1s) | N (3s) |
| `Impl L3→L4 [A->!B] (α=0.9)` | implication-direction (L3→L4) | Y (2s) | N (1s) | N (1s) | N (2s) |
| `Impl L3→L4 [A->!B] (α=0.95)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (1s) | N (3s) |
| `Impl L3→L4 [A->!B] (α=0.99)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L3→L4 [A->B] (α=0.9)` | implication-direction (L3→L4) | Y (0s) | N (14s) | N (2s) | N (2s) |
| `Impl L3→L4 [A->B] (α=0.95)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L3→L4 [A->B] (α=0.99)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L4→L5 [!A->!B] (α=0.9)` | implication-direction (L4→L5) | Y (9s) | N (1s) | N (1s) | N (2s) |
| `Impl L4→L5 [!A->!B] (α=0.95)` | implication-direction (L4→L5) | N (0s) | N (83s) | N (1s) | N (2s) |
| `Impl L4→L5 [!A->!B] (α=0.99)` | implication-direction (L4→L5) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L4→L5 [!A->B] (α=0.9)` | implication-direction (L4→L5) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L4→L5 [!A->B] (α=0.95)` | implication-direction (L4→L5) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L4→L5 [!A->B] (α=0.99)` | implication-direction (L4→L5) | N (0s) | N (0s) | N (2s) | N (3s) |
| `Impl L4→L5 [A->!B] (α=0.9)` | implication-direction (L4→L5) | N (0s) | N (12s) | N (1s) | N (2s) |
| `Impl L4→L5 [A->!B] (α=0.95)` | implication-direction (L4→L5) | N (0s) | N (8s) | N (2s) | N (2s) |
| `Impl L4→L5 [A->!B] (α=0.99)` | implication-direction (L4→L5) | N (0s) | N (0s) | N (2s) | N (3s) |
...
| `Impl L1→L2 (α=0.99)` | implication-only (L1→L2) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L2→L3 (α=0.9)` | implication-only (L2→L3) | Y (0s) | N (1s) | N (11s) | N (4s) |
| `Impl L2→L3 (α=0.95)` | implication-only (L2→L3) | N (0s) | N (1s) | N (2s) | N (3s) |
| `Impl L2→L3 (α=0.99)` | implication-only (L2→L3) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L3→L4 (α=0.9)` | implication-only (L3→L4) | Y (0s) | Y (2s) | T/o | N (3s) |
| `Impl L3→L4 (α=0.95)` | implication-only (L3→L4) | Y (0s) | N (13s) | N (7s) | N (2s) |
| `Impl L3→L4 (α=0.99)` | implication-only (L3→L4) | N (1s) | N (1s) | N (2s) | N (2s) |
| `Impl L4→L5 (α=0.9)` | implication-only (L4→L5) | Y (7s) | N (5s) | N (1s) | N (2s) |
| `Impl L4→L5 (α=0.95)` | implication-only (L4→L5) | N (0s) | N (2s) | N (1s) | N (2s) |
| `Impl L4→L5 (α=0.99)` | implication-only (L4→L5) | N (0s) | N (1s) | N (8s) | N (2s) |
| `Impl L0→L1 [!A->!B] (α=0.9)` | implication-direction (L0→L1) | N (0s) | N (0s) | N (1s) | N (2s) |
...
| `Impl L1→L2 [A->!B] (α=0.99)` | implication-direction (L1→L2) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L1→L2 [A->B] (α=0.9)` | implication-direction (L1→L2) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L1→L2 [A->B] (α=0.95)` | implication-direction (L1→L2) | N (0s) | N (0s) | N (1s) | N (8s) |
| `Impl L1→L2 [A->B] (α=0.99)` | implication-direction (L1→L2) | N (0s) | N (0s) | N (2s) | N (2s) |
| `Impl L2→L3 [!A->!B] (α=0.9)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L2→L3 [!A->!B] (α=0.95)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L2→L3 [!A->!B] (α=0.99)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (1s) | N (2s) |
...
| `Impl L2→L3 [A->B] (α=0.99)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L3→L4 [!A->!B] (α=0.9)` | implication-direction (L3→L4) | Y (0s) | N (21s) | N (3s) | N (2s) |
| `Impl L3→L4 [!A->!B] (α=0.95)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (3s) | N (2s) |
| `Impl L3→L4 [!A->!B] (α=0.99)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L3→L4 [!A->B] (α=0.9)` | implication-direction (L3→L4) | Y (2s) | N (13s) | N (3s) | N (2s) |
| `Impl L3→L4 [!A->B] (α=0.95)` | implication-direction (L3→L4) | N (0s) | N (35s) | N (1s) | N (2s) |
| `Impl L3→L4 [!A->B] (α=0.99)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L3→L4 [A->!B] (α=0.9)` | implication-direction (L3→L4) | Y (1s) | N (0s) | N (1s) | N (2s) |
| `Impl L3→L4 [A->!B] (α=0.95)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L3→L4 [A->!B] (α=0.99)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L3→L4 [A->B] (α=0.9)` | implication-direction (L3→L4) | Y (0s) | N (6s) | N (1s) | N (2s) |
| `Impl L3→L4 [A->B] (α=0.95)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L3→L4 [A->B] (α=0.99)` | implication-direction (L3→L4) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L4→L5 [!A->!B] (α=0.9)` | implication-direction (L4→L5) | Y (9s) | N (14s) | N (2s) | N (2s) |
| `Impl L4→L5 [!A->!B] (α=0.95)` | implication-direction (L4→L5) | N (0s) | N (26s) | N (2s) | N (2s) |
| `Impl L4→L5 [!A->!B] (α=0.99)` | implication-direction (L4→L5) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L4→L5 [!A->B] (α=0.9)` | implication-direction (L4→L5) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L4→L5 [!A->B] (α=0.95)` | implication-direction (L4→L5) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L4→L5 [!A->B] (α=0.99)` | implication-direction (L4→L5) | N (0s) | N (0s) | N (2s) | N (3s) |
| `Impl L4→L5 [A->!B] (α=0.9)` | implication-direction (L4→L5) | N (0s) | N (15s) | N (1s) | N (2s) |
| `Impl L4→L5 [A->!B] (α=0.95)` | implication-direction (L4→L5) | N (0s) | N (9s) | N (1s) | N (2s) |
