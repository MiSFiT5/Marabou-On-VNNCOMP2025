...
- **Network outputs at midpoint:** `[-0.0207, -0.0176, -0.018, -0.0175, -0.0178]`
...
|--------|------------|----------------|--------------------------|
| 1 | Weak Left | 0.02 | `ALWAYS_OFF (α=0.9)` [C], `ALWAYS_ON+OFF (α=0.9)` [C], `Impl L1→L2 (α=0.9)` [B/L1→L2], `Impl L2→L3 (α=0.9)` [B/L2→L3], `Impl L2→L3 (α=0.95)` [B/L2→L3], `Impl L3→L4 (α=0.9)` [B/L3→L4], `Impl L3→L4 [!A->!B] (α=0.9)` [C], `Impl L3→L4 [A->!B] (α=0.9)` [C] |
| 2 | Weak Right | 0.02 | `ALWAYS_OFF (α=0.9)` [C], `ALWAYS_ON+OFF (α=0.9)` [C], `Impl L1→L2 (α=0.9)` [B/L1→L2], `Impl L2→L3 (α=0.9)` [B/L2→L3], `Impl L2→L3 (α=0.95)` [B/L2→L3], `Impl L3→L4 (α=0.9)` [B/L3→L4], `Impl L3→L4 [!A->!B] (α=0.9)` [C], `Impl L3→L4 [A->!B] (α=0.9)` [C] |
| 3 | Strong Left | 0.02 | `ALWAYS_OFF (α=0.9)` [C], `ALWAYS_ON+OFF (α=0.9)` [C], `Impl L1→L2 (α=0.9)` [B/L1→L2], `Impl L2→L3 (α=0.9)` [B/L2→L3], `Impl L2→L3 (α=0.95)` [B/L2→L3], `Impl L3→L4 (α=0.9)` [B/L3→L4], `Impl L3→L4 [!A->!B] (α=0.9)` [C], `Impl L3→L4 [A->!B] (α=0.9)` [C] |
| 4 | Strong Right | 0.02 | `ALWAYS_OFF (α=0.9)` [C], `ALWAYS_ON+OFF (α=0.9)` [C], `Impl L1→L2 (α=0.9)` [B/L1→L2], `Impl L2→L3 (α=0.9)` [B/L2→L3], `Impl L2→L3 (α=0.95)` [B/L2→L3], `Impl L3→L4 (α=0.9)` [B/L3→L4], `Impl L3→L4 [!A->!B] (α=0.9)` [C], `Impl L3→L4 [A->!B] (α=0.9)` [C] |
...
- **Winning kept experiments:**
  ...
  - `Impl L2→L3 (α=0.95)` (implication-only (L2→L3)) from `B/L2→L3`
...
| `ALWAYS_OFF (α=0.9)` | unary-only | Y (1s) | N (0s) | N (0s) | N (0s) |
...
| `ALWAYS_ON+OFF (α=0.9)` | unary-only | Y (1s) | N (0s) | N (0s) | N (0s) |
...
| `Impl L4→L5 (α=0.9)` | implication-only (L4→L5) | N (1s) | N (1s) | N (2s) | N (3s) |
| `Impl L4→L5 (α=0.95)` | implication-only (L4→L5) | N (1s) | N (1s) | N (2s) | N (3s) |
| `Impl L4→L5 (α=0.99)` | implication-only (L4→L5) | N (1s) | N (1s) | N (2s) | N (3s) |
...
| `Impl L2→L3 [!A->B] (α=0.9)` | implication-direction (L2→L3) | N (2s) | N (1s) | N (2s) | N (3s) |
| `Impl L2→L3 [!A->B] (α=0.95)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (2s) | N (2s) |
...
| `Impl L2→L3 [A->B] (α=0.95)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L2→L3 [A->B] (α=0.99)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L3→L4 [!A->!B] (α=0.9)` | implication-direction (L3→L4) | Y (1s) | N (1s) | N (2s) | N (3s) |
...
| `Impl L3→L4 [A->!B] (α=0.9)` | implication-direction (L3→L4) | Y (1s) | N (1s) | N (1s) | N (2s) |
...
| `Impl L0→L1 (α=0.95)` | implication-only (L0→L1) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L0→L1 (α=0.99)` | implication-only (L0→L1) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L1→L2 (α=0.9)` | implication-only (L1→L2) | Y (0s) | N (1s) | N (1s) | N (3s) |
| `Impl L1→L2 (α=0.95)` | implication-only (L1→L2) | N (0s) | N (1s) | N (2s) | N (3s) |
| `Impl L1→L2 (α=0.99)` | implication-only (L1→L2) | N (0s) | N (1s) | N (2s) | N (3s) |
| `Impl L2→L3 (α=0.9)` | implication-only (L2→L3) | Y (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L2→L3 (α=0.95)` | implication-only (L2→L3) | Y (0s) | N (1s) | N (1s) | N (2s) |
| `Impl L2→L3 (α=0.99)` | implication-only (L2→L3) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L3→L4 (α=0.9)` | implication-only (L3→L4) | Y (0s) | N (1s) | N (2s) | N (2s) |
...
| `Impl L2→L3 [A->B] (α=0.9)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L2→L3 [A->B] (α=0.95)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L2→L3 [A->B] (α=0.99)` | implication-direction (L2→L3) | N (0s) | N (0s) | N (3s) | N (2s) |
| `Impl L3→L4 [!A->!B] (α=0.9)` | implication-direction (L3→L4) | Y (1s) | N (1s) | N (2s) | N (2s) |
...
| `Impl L4→L5 (α=0.9)` | implication-only (L4→L5) | N (1s) | N (1s) | N (2s) | N (2s) |
| `Impl L4→L5 (α=0.95)` | implication-only (L4→L5) | N (1s) | N (1s) | N (2s) | N (3s) |
| `Impl L4→L5 (α=0.99)` | implication-only (L4→L5) | N (0s) | N (1s) | N (2s) | N (3s) |
...
| `Impl L2→L3 [!A->B] (α=0.9)` | implication-direction (L2→L3) | N (2s) | N (1s) | N (2s) | N (2s) |
| `Impl L2→L3 [!A->B] (α=0.95)` | implication-direction (L2→L3) | N (0s) | N (0s) | N (2s) | N (2s) |
| `Impl L2→L3 [!A->B] (α=0.99)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (2s) | N (2s) |
| `Impl L2→L3 [A->!B] (α=0.9)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (2s) | N (3s) |
| `Impl L2→L3 [A->!B] (α=0.95)` | implication-direction (L2→L3) | N (0s) | N (1s) | N (2s) | N (2s) |
