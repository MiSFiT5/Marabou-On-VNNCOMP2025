...
| Rule | Y% | Y | Total |
|------|-----|---|-------|
| `ALWAYS_OFF (α=0.99)` | 100.0% | 360 | 360 |
| `ALWAYS_ON (α=0.99)` | 100.0% | 360 | 360 |
| `ALWAYS_ON+OFF (α=0.99)` | 100.0% | 360 | 360 |
| `Impl L0→L1 (α=0.99)` | 100.0% | 360 | 360 |
| `Impl L1→L2 (α=0.99)` | 100.0% | 360 | 360 |
| `Impl L2→L3 (α=0.99)` | 100.0% | 360 | 360 |
